  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Render Backend Warning */}
        <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 border-b border-amber-500/20 px-6 py-2">
          <div className="max-w-7xl mx-auto flex items-center gap-2 text-xs text-amber-200/80">
            <svg className="w-4 h-4 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span>
              <strong>Heads up:</strong> Backend is on Render&apos;s free tier — first request may take 30-60s to wake up. Subsequent requests will be fast!
            </span>
          </div>
        </div>
